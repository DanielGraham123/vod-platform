      ...
      >
        <b-col lg="4" class="r-mb-23">
          <div class="text-left">
            <a href="#;">
              <img
                src="../../../assets/images/frontend/parallax/parallax-logo.png"
                class="img-fluid"
                alt="bailey"
              />
            </a>
            ...
            <div class="parallax-buttons">
              <router-link to="/movies/movie-detail" class="btn btn-hover">
                Play Now
              </router-link>
              <router-link to="/movies/movie-detail" class="btn btn-link">
                More details
              </router-link>
            </div>
          </div>
        ...
        <b-col lg="8">
          <div class="parallax-img">
            <router-link to="/movies/movie-detail">
              <img
                src="../../../assets/images/frontend/parallax/p1.jpg"
