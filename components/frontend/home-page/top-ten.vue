...
export default {
  ...
  data() {
    return {
      ...
      topTenNavSlider: [
        {
          image: require("../../../assets/images/frontend/top-10/01.jpg"),
          title: "The Illusion",
          age: "10+",
          time: "3h 15m",
        },
        {
          image: require("../../../assets/images/frontend/top-10/02.jpg"),
          title: "Burning",
          age: "13+",
          time: "3h 15m",
        },
        {
          image: require("../../../assets/images/frontend/top-10/03.jpg"),
          title: "Hubby Kubby",
          age: "15+",
          time: "2h 15m",
        },
        {
          image: require("../../../assets/images/frontend/top-10/04.jpg"),
          title: "Open Dead Shot",
          age: "18+",
          time: "3h 15m",
        },
        {
          image: require("../../../assets/images/frontend/top-10/05.jpg"),
          title: "Jumbo Queen",
          age: "6+",
          time: "4h 15m",
        },
        {
          image: require("../../../assets/images/frontend/top-10/06.jpg"),
