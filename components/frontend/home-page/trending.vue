          ...
          <div class="trending-contens">
            ...
            >
              <li v-for="(item, index) in items" :key="index">
                <div
                  class="tranding-block position-relative"
                  :style="{
                    backgroundImage: `url(${require('../../../assets/images/frontend/trending/' +
                      item.backgroudImage)})`,
                  }"
                >
                      ...
                      <div class="trending-content">
                            ...
                            <div class="trending-list mt-4">
                              <div class="text-primary title">
                                ...
                                <span class="text-body"
                                  >Wagner Moura, Boyd Holbrook, Joanna</span
                                >
                              </div>
                              <div class="text-primary title">
                                Genres:
                                <span class="text-body"
                                  >Crime, Action, Thriller, Biography</span
                                >
                              </div>
                              <div class="text-primary title">
                                This Is:
                                <span class="text-body">Violent, Forceful</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              class="iq-custom-select d-inline-block sea-epi"
                            >
                              <V-select
                                v-model="selected"
...
export default {
  ...
  data() {
    return {
      ...
      episodData: [
        {
          image: require("../../../assets/images/frontend/episodes/01.jpg"),
          title: "Episode 1",
          mb: "2.25m",
          text: "Lorem Ipsum is simply dummy text of the printingLorem Ipsum is simply dummy text of the printing",
        },
        {
          image: require("../../../assets/images/frontend/episodes/02.jpg"),
          title: "Episode 2",
          mb: "2.25m",
          text: "Lorem Ipsum is simply dummy text of the printingLorem Ipsum is simply dummy text of the printing",
        },
        {
          image: require("../../../assets/images/frontend/episodes/03.jpg"),
          title: "Episode 3",
          mb: "2.25m",
          text: "Lorem Ipsum is simply dummy text of the printingLorem Ipsum is simply dummy text of the printing",
        },
        {
          image: require("../../../assets/images/frontend/episodes/04.jpg"),
          title: "Episode 4",
          mb: "2.25m",
          text: "Lorem Ipsum is simply dummy text of the printingLorem Ipsum is simply dummy text of the printing",
        },
        {
          image: require("../../../assets/images/frontend/episodes/05.jpg"),
          title: "Episode 5",
          mb: "2.25m",
          text: "Lorem Ipsum is simply dummy text of the printingLorem Ipsum is simply dummy text of the printing",
        },
