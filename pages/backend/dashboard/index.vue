    ...
    <b-row class="row">
      <b-col lg="8">
          ...
          <b-col sm="6" lg="6" xl="3">
            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
              <div class="iq-card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="iq-cart-text text-capitalize">
                    <p class="mb-0 font-size-14">Rated This App</p>
                  </div>
          ...
          <b-col sm="6" lg="6" xl="3">
            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
              <div class="iq-card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="iq-cart-text text-capitalize">
                    <p class="mb-0 font-size-14">Downloaded</p>
                  </div>
              ...
              <div class="iq-card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="iq-cart-text text-uppercase">
                    <p class="mb-0 font-size-14">Visitors</p>
                  </div>
        ...
        <div class="iq-card">
          ...
          <div class="iq-card-body">
            <Slick
              class="list-unstyled row top-rated-item mb-0"
              ref="dSlick"
              :option="option1"
            >
              <li
                v-for="(data, index) in topRated"
                :key="index"
                class="col-12 iq-rated-box"
              >
      ...
      <b-col lg="4">
        <div
          class="iq-card iq-card iq-card-block iq-card-stretch iq-card-height"
        >
      ...
      <b-col lg="8">
        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
          ...
          >
            ...
            <div
              class="iq-card-header-toolbar d-flex align-items-center seasons"
            >
              <div
                class="iq-card-header-toolbar d-flex align-items-center seasons"
              >
                <div class="iq-custom-select d-inline-block sea-epi s-margin">
                  <V-select
                    :options="sessonOption"
                    v-model="selected"
                    label="Select"
                    class="form-control season-select select2-hidden-accessible"
                  >
            ...
            <div class="col-lg-7">
              <div class="row list-unstyled mb-0 pb-0">
                <b-col class="col-sm-6 col-md-4 col-lg-6 mb-3">
                  ...
                  <div class="media align-items-center">
                    <div class="iq-icon-box-view rounded mr-3 iq-bg-primary">
                      <i class="las la-film font-size-32"></i>
                    </div>
                    <div class="media-body text-white">
                ...
                <b-col sm="6" md="4" lg="6" class="mb-3">
                  ...
                  <div class="media align-items-center">
                    <div class="iq-icon-box-view rounded mr-3 iq-bg-secondary">
                      <i class="las la-laugh-squint font-size-32"></i>
                    </div>
                    <div class="media-body text-white">
                ...
                <b-col sm="6" md="4" lg="6" class="mb-3">
                  ...
                  <div class="media align-items-center">
                    <div class="iq-icon-box-view rounded mr-3 iq-bg-info">
                      <i class="las la-skull-crossbones font-size-32"></i>
                    </div>
                    <div class="media-body text-white">
                ...
                <b-col sm="6" md="4" lg="6" class="mb-3">
                  ...
                  <div class="media align-items-center">
                    <div class="iq-icon-box-view rounded mr-3 iq-bg-warning">
                      <i class="las la-theater-masks font-size-32"></i>
                    </div>
                    <div class="media-body text-white">
                ...
                <b-col sm="6" md="4" lg="6" class="mb-lg-0 mb-3">
                  ...
                  <div class="media align-items-center mb-lg-0 mb-3">
                    <div class="iq-icon-box-view rounded mr-3 iq-bg-success">
                      <i class="las la-child font-size-32"></i>
                    </div>
                    <div class="media-body text-white">
                ...
                <b-col
                  ...
                  md="4"
                  lg="6"
                  class="col-sm-6 col-md-4 col-lg-6 mb-lg-0 mb-3"
                >
                  <Progressbar :value="80" :verticle="true" color="danger" />
                  <div class="media align-items-center">
                    <div class="iq-icon-box-view rounded mr-3 iq-bg-danger">
                      <i class="las la-grin-beam font-size-32"></i>
                    </div>
                    <div class="media-body text-white">
  ...
  data() {
    return {
      options: {
        ...
        colors: ["#DABF34", "#f68a04", "#007aff", "#dc3545"],
        labels: [
          "New Customer",
